...
# Wichtig: /data ist in HF Spaces beschreibbar
...
# ---------- Jinja2-Env (für Template-Filter, Datumsformat) ----------
env = Environment(
...
chain1, chain2, memory1 = build_chains(llm1, llm2, RETRIEVER, debug=DEBUG)
...
# Statische Auslieferung der generierten PDFs (aus /data/outputs)
app.mount("/outputs", StaticFiles(directory=str(OUTPUT_DIR)), name="outputs")

# Root (hilft Deployments zu erkennen, dass die App lebt)
@app.get("/")
def root():
    return {
        "ok": True,
...
if __name__ == "__main__":
    ...
    # Wichtig: Modulname ist "main", Variable heißt "app"
