...
def build_chains(llm1, llm2, retriever, debug: bool = False):
    ...
    template=(
        ...
        # WICHTIG: geschweifte Klammern im Beispiel doppeln!
        ...
        "- Enthält die QUESTION unter 'Materialien:' eine Liste, match diese Einträge streng gegen den KATALOG und übernimm NUR die Treffer – in der Reihenfolge der Nutzerliste.\n"
        "- Falls in der QUESTION zusätzlich Mengen genannt sind, übernimm sie; sonst setze \"menge\": null und \"einheit\": null (nicht schätzen).\n\n"
        "OHNE NUTZERLISTE:\n"
