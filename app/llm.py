...
def build_chains(llm1, llm2, retriever, debug: bool = False):
    ...
    template=(
        ...
        "- Beispiel: \"- Dispersionsfarbe: 28 L (Gesamtfläche 125 m² × 2 / 10 m²/L × 1,10 = 27,5 L → 28 L)\".\n"
        "- Beispiel: \"- Tiefengrund: 6 L (125 m² / 15 m²/L × 1,10 = 9,17 L → 10 L)\" – Werte je nach Eingabe berechnen.\n"
        "- Für Folie/Band/Rollen kurz die Heuristik notieren, z. B. \"(Abdeckung Räume, Türen/Fenster, Reserve)\".\n\n"
        "Maschinenanhang:\n"
        ...
        "- Gesamtfläche: ... m²\n\n"
        "**Materialbedarf**\n"
        "- Dispersionsfarbe: ... L (Gesamtfläche ... m² × 2 / 10 m²/L × 1,10 = ... L → ... L)\n"
        "- Tiefengrund: ... L (... m² / 15 m²/L × 1,10 = ... L → ... L)\n"
        "- Abdeckfolie: ... Rolle(n) (Abdeckung ..., Reserve)\n"
        "- Abklebeband: ... Rolle(n) (Tür-/Fensterkanten, Reserve)\n"
        "- Malerrolle: ... Stück (Arbeitskomfort/Wechsel, Reserve)\n\n"
