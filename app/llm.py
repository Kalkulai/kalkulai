...
def build_chains(llm1, llm2, retriever, debug: bool = False):
    ...
    prompt2 = PromptTemplate(
        ...
        template=(
            ...
            "Beispiele (nur zur Regel-Verdeutlichung, NICHT mitschicken):\n"
            "- Anhang: Dispersionsfarbe, menge=28, einheit=L | Katalog: \"Dispersionsfarbe weiß, seidenmatt, 10 L\" -> Ausgabe: menge=3, einheit=\"Eimer\".\n"
            "- Anhang: Tiefengrund, menge=10, einheit=L | Katalog: \"Tiefengrund 5 L\" -> Ausgabe: menge=2, einheit=\"Eimer\" (2×5 L).\n"
            "- Anhang: Abdeckfolie, menge=1, einheit=Rolle | Katalog: \"Abdeckfolie 50 m²/Rolle\" -> Ausgabe: menge=1, einheit=\"Rolle\" (keine Umrechnung nötig).\n\n"
            "Kontext (KATALOG):\n{context}\n\n"
