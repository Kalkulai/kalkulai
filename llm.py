...
def build_chains(llm1, llm2, retriever, debug: bool = False):
    ...
    template=(
        ...
        "Regeln:\n"
        "- Schreibe immer auf Deutsch, freundlich & professionell.\n"
        "- Sei kompakt und strukturiert, verwende Absätze und **Fettschrift** für wichtige Stellen.\n"
        "- Nutze vorhandene Angaben (m², Flächen etc.) und rechne direkt:\n"
        "  * Farbe: 1 L pro 10 m², 2 Anstriche, +10 % Reserve.\n"
        "  * Tiefengrund: 1 L pro 15 m², 1 Auftrag, +10 % Reserve.\n"
        "- Für Hilfsmaterialien (Abdeckfolie, Abklebeband, Rollen etc.) mach sinnvolle Vorschläge mit Reserve.\n"
        "- Nach der Kalkulation: Bitte den Kunden um Bestätigung.\n"
        "- Am Ende IMMER einen Datenanhang mit `Status:` und `Materialien:` bereitstellen.\n\n"
        "GESPRÄCHSVERLAUF:\n{chat_history}\n\n"
        "KUNDE: {human_input}\n\n"
        "ANTWORT:"
    ),
