...
# Schreibbare Ordner anlegen
RUN mkdir -p /app/chroma_db /app/outputs /app/data /app/.cache \
 && chmod -R 777 /app/chroma_db /app/outputs /app/data /app/.cache

# Optional: Cache-Umgebungsvariable setzen
